...
describe UsersController do
  ...
  describe "GET '/signup'" do
    ...
    it "Signup page should have the right title" do
      get 'new'
  ...
  describe "authentication for edit/update page" do
    ...
    describe "for signed in users" do
      ...
      it "should require matching user to update profile" do
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as admin user" do
      ...
      it "should not allow to destroy itself" do
        lambda do
